...
**Projeto:** Japan Express / `temu_shop`  
**Data:** 23/07/2026  
...
- Uma referência residual "サクラエクスプレス" (nome de marca anterior em japonês) foi corrigida para "Japan Express" em 4 chaves de tradução.
...
**Risco [INFERÊNCIA]:** envio de spam, phishing ou mensagens ofensivas em nome da Japan Express para clientes inscritos, além de consumo de recursos.
