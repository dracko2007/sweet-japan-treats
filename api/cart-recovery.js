...
function buildRecoveryEmail(name, items, origin) {
  ...
  return {
    subject: `Seu carrinho esta esperando! 🛒 - ${BRAND}`,
    html: `
    <div style="font-family:Arial,Helvetica,sans-serif;max-width:560px;margin:0 auto;background:#fff;border:1px solid #eee;border-radius:14px;overflow:hidden">
      ...
      <div style="padding:24px;color:#333;font-size:15px;line-height:1.6">
        ...
        <table style="width:100%;font-size:14px;margin:12px 0">${itemsHtml}${more}</table><br>
        <div style="text-align:center;margin:20px 0">
          <a href="${origin}/carrinho" style="display:inline-block;background:#ec4899;color:#fff;text-decoration:none;padding:14px 28px;border-radius:10px;font-weight:bold;font-size:16px">Finalizar meu pedido</a>
        </div>
