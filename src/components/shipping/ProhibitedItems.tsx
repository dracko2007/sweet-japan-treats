...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Aerossóis e sprays pressurizados', detail: 'Proibidos em EMS/Avião. Permitidos apenas por via marítima SAL com declaração.' },
  ...
  },
  {
    ...
    items: [
      ...
      { name: 'Vinhos e bebidas alcoólicas', detail: 'Permitidos via SAL/marítimo apenas. Proibidos em EMS/avião. Limite: 12 garrafas (720ml).' },
