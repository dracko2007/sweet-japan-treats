...
export const negotiationService = {
  async create(data: Omit<Negotiation, 'id' | 'createdAt' | 'resolvedAt'>): Promise<Negotiation> {
  ...
  async approve(id: string, approvedDiscountYen: number, adminNote: string): Promise<void> {
