        ...
        <div className="prose prose-gray max-w-none space-y-8 text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li><strong>Rastreamento obrigatório:</strong> o envio de devolução deve obrigatoriamente possuir código de rastreamento para comprovação da entrega. A Japan Express não se responsabiliza por extravios, roubos ou avarias ocorridas durante o transporte de retorno enviado pelo cliente.</li>
              <li><strong>Erro da loja ou defeito:</strong> em casos comprovados de envio de produto incorreto ou item com defeito de fabricação, o custo do frete de devolução será totalmente assumido pela Japan Express.</li>
            </ul>
          </section>
