      ...
      <div className="container mx-auto px-4 max-w-3xl">
        ...
        <div className="prose prose-gray max-w-none space-y-8 text-foreground/80 leading-relaxed">
          ...
          <section>
            ...
            <p>
              Ao acessar ou utilizar o site <strong>japanexpress-store.com</strong>, você concorda em cumprir estes
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Os prazos informados no checkout são estimativas baseadas nos dados dos Correios do Japão e do país de destino. A Japan Express não se responsabiliza por atrasos decorrentes de greves, intempéries climáticas, retenções alfandegárias ou trâmites operacionais da Receita Federal.</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>Em caso de desistência ou arrependimento, o custo do frete de retorno é de responsabilidade do cliente. Em casos comprovados de produto com defeito de fabricação ou erro no envio cometido pela loja, o frete de devolução será custeado pela Japan Express.</li>
          ...
          <section>
            ...
            <p>
              Todo o conteúdo disponível no site <strong>japanexpress-store.com</strong> — incluindo textos, fotos,
              marcas, logotipos, layouts e ilustrações — é de propriedade da Japan Express ou devidamente licenciado.
          ...
          <section>
            ...
            <p>
              A Japan Express atua em conformidade com as normas de comércio e defesa do consumidor. A
