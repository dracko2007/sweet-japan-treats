    ...
    VitePWA({
      ...
      manifest: {
        ...
        icons: [
          ...
          { src: "/icons/icon-splash-512x512.png?v=7", sizes: "512x512", type: "image/png", purpose: "any" },
          { src: "/icons/icon-maskable-512x512.png?v=7", sizes: "512x512", type: "image/png", purpose: "maskable" },
        ],
      },
      devOptions: {
        enabled: true,
